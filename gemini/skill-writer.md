...
<!-- PATH CONVENTION (Gemini)
  Companion files are installed to ~/.gemini/ by running: ./gemini/install.sh

    refs/security-patterns.md  →  ~/.gemini/refs/security-patterns.md
    refs/use-to-evolve.md      →  ~/.gemini/refs/use-to-evolve.md
    refs/convergence.md        →  ~/.gemini/refs/convergence.md
    refs/self-review.md        →  ~/.gemini/refs/self-review.md
    refs/evolution.md          →  ~/.gemini/refs/evolution.md
    templates/                 →  ~/.gemini/templates/
    eval/                      →  ~/.gemini/eval/
    optimize/                  →  ~/.gemini/optimize/
