...
**Key Metrics**: Text Score ≥ 8.0, Runtime Score ≥ 8.0, Variance < 1.0, Trace Compliance ≥ 0.90
...
- **Certification System**: CERTIFIED = Text≥8.0 AND Runtime≥8.0 AND Variance<1.0 AND TraceCompliance≥0.90
...
git clone https://github.com/anomalyco/agent-skills-creator.git
