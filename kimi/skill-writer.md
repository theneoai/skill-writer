...
<!-- PATH CONVENTION (Kimi / Moonshot AI)
  Companion files are installed to ~/.config/kimi/ by running: ./kimi/install.sh

    refs/security-patterns.md  →  ~/.config/kimi/refs/security-patterns.md
    refs/use-to-evolve.md      →  ~/.config/kimi/refs/use-to-evolve.md
    refs/convergence.md        →  ~/.config/kimi/refs/convergence.md
    refs/self-review.md        →  ~/.config/kimi/refs/self-review.md
    refs/evolution.md          →  ~/.config/kimi/refs/evolution.md
    templates/                 →  ~/.config/kimi/templates/
    eval/                      →  ~/.config/kimi/eval/
    optimize/                  →  ~/.config/kimi/optimize/
