...
<!-- PATH CONVENTION (Hermes)
  Companion files are installed to ~/.hermes/ by running: ./hermes/install.sh

    refs/security-patterns.md  →  ~/.hermes/refs/security-patterns.md
    refs/use-to-evolve.md      →  ~/.hermes/refs/use-to-evolve.md
    refs/convergence.md        →  ~/.hermes/refs/convergence.md
    refs/self-review.md        →  ~/.hermes/refs/self-review.md
    refs/evolution.md          →  ~/.hermes/refs/evolution.md
    templates/                 →  ~/.hermes/templates/
    eval/                      →  ~/.hermes/eval/
    optimize/                  →  ~/.hermes/optimize/
